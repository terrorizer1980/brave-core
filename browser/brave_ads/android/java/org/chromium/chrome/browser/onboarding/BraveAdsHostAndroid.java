...
public class BraveAdsHostAndroid implements BraveTalkOptInPopupListener {
    ...
    @CalledByNative
    public void openBraveTalkOptInPopup(boolean showRewardsOptIn) {
        ...
        braveActivity.openBraveTalkOptInPopup(this, showRewardsOptIn);
    }

    @NativeMethods
    interface Natives {
        void notifyAdsEnabled(long nativeBraveAdsHostAndroid,
                              BraveAdsHostAndroid caller);
        void notifyPopupClosed(long nativeBraveAdsHostAndroid,
                               BraveAdsHostAndroid caller);
    }
}
