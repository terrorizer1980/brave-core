...
#define BRAVE_NETWORK_HANDLER_GET_COOKIES_RETRIEVE_CALL_ARGS \
...
#define BRAVE_NETWORK_HANDLER_SET_COOKIES_SET_COOKIE_OPTIONS                 \
  options.set_top_frame_origin(                                              \
      host_ ? absl::make_optional<url::Origin>(host_->ComputeTopFrameOrigin( \
...
#undef BRAVE_NETWORK_HANDLER_GET_COOKIES_RETRIEVE_CALL_ARGS
